...
function distance_sanity_check(word1, word2)
	word1.approximator[] == word2.approximator[] || 
		throw(ArgumentError("words must be generated by the same approximator"))
	word1.n == word2.n || 
		throw(DimensionMismatch("original sequences have different lengths: $(word1.n) vs $(word2.n)"))
	return true
end
